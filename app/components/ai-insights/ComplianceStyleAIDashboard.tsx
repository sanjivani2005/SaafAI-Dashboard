...
const slaAlerts = [
  { id: "AI001", assignedTo: "Rajesh Kumar", timeRemaining: "2h 15m", status: "Pending" },
  { id: "AI002", assignedTo: "Sunita Patel", timeRemaining: "45m", status: "In Progress" },
  { id: "AI003", assignedTo: "Amit Singh", timeRemaining: "5h 30m", status: "Escalated" },
  { id: "AI004", assignedTo: "Priya Sharma", timeRemaining: "Resolved", status: "Resolved" },
  { id: "AI005", assignedTo: "Vijay Kumar", timeRemaining: "1h 10m", status: "In Progress" },
];
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-white p-4 rounded-lg shadow">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Total AI Predictions</h3>
              <p className="text-2xl font-bold text-gray-800">182</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Active Anomalies</h3>
              <p className="text-2xl font-bold text-gray-800">24</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow">
              <h3 className="text-sm font-medium text-gray-600 mb-2">AI Accuracy %</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">AI Performance SLA</h3>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Assigned AI</th>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">AI Response Time Trend</h3>
            ...
            {/* Pie Chart */}
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">AI Alert Categories</h3>
              <ResponsiveContainer width="100%" height={250}>
                <PieChart>
                  <Pie
          ...
          {/* Workflow Overview */}
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">AI Workflow Overview</h3>
            <div className="flex items-center justify-around">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 font-medium">AI Notification</p>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 font-medium">AI Supervisor</p>
                <p className="text-xs text-orange-600">Escalated to AI Supervisor</p>
              </div>
            </div>
          </div>
        </main>
